...
# Make executable
chmod +x "$MACOS_DIR/restart-bitcoin-apps"
...
# Remove the old separate apps
rm -rf "$HOME/Desktop/Kill Port 1000.app"
rm -rf "$HOME/Desktop/Start Bitcoin Apps.app"

echo "✅ App created successfully at: $APP_DIR"
echo ""
echo "🗑️  Removed old separate apps (Kill Port 1000 & Start Bitcoin Apps)"
echo ""
...
echo ""
echo "One click = complete restart!"