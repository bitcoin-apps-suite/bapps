...
const apps = [
  ...
  // BSV Ecosystem Apps
  {
    id: 'haste-arcade',
    name: 'Haste Arcade',
    fullName: 'Haste Arcade Gaming',
    ticker: '$HST',
    icon: <Gamepad2 size={24} />,
    color: '#EF4444',
    description: 'Earn BSV by playing games with instant leaderboard payouts',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '2.1.0',
  ...
  },
  {
    id: 'cryptofights',
    name: 'CryptoFights',
    fullName: 'CryptoFights RPG',
    ticker: '$FIGHT',
    icon: <Sword size={24} />,
    color: '#7C2D12',
    description: 'Earn by creating and trading items in this blockchain RPG',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '1.8.5',
  ...
  },
  {
    id: 'twetch',
    name: 'Twetch',
    fullName: 'Twetch Social Network',
    ticker: '$TWETCH',
    icon: <MessageCircle size={24} />,
    color: '#1DA1F2',
    description: 'Decentralized social network where you earn from your content',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '3.2.1',
  ...
  },
  {
    id: 'relayx',
    name: 'RelayX',
    fullName: 'RelayX Wallet',
    ticker: '$RUN',
    icon: <Wallet size={24} />,
    color: '#10B981',
    description: 'Convert local currency to BSV with debit card support',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '4.1.2',
  ...
  },
  {
    id: 'bullishart',
    name: 'BullishArt',
    fullName: 'BullishArt NFT Marketplace',
    ticker: '$BULL',
    icon: <ImageIcon size={24} />,
    color: '#F59E0B',
    description: 'Digital art trading with transparent NFT ownership',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '2.3.0',
  ...
  },
  {
    ...
    color: '#8B5CF6',
    description: 'Decentralized exchange with liquidity pools on BSV',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '1.9.3',
  ...
  },
  {
    id: 'tonicpow',
    name: 'TonicPow',
    fullName: 'TonicPow Advertising',
    ticker: '$TONIC',
    icon: <TrendingUp size={24} />,
    color: '#DC2626',
    description: 'Peer-to-peer advertising platform to earn BSV',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '2.4.2',
  ...
  },
  {
    id: 'money-button',
    name: 'Money Button',
    fullName: 'Money Button Wallet',
    ticker: '$MB',
    icon: <Send size={24} />,
    color: '#059669',
    description: 'Non-custodial wallet with easy payments and data writing',
    category: 'Third Party Apps',
    status: 'installed' as const,
    isThirdParty: true,
    version: '4.7.1',
